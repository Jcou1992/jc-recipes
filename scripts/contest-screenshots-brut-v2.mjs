...
// Output goes under contest/winner/after-screenshots-v2/{theme}/{viewport}/{slug}.png
//
// Usage: node scripts/contest-screenshots-brut-v2.mjs
//   Expects a dev server already running on :3102 and TEST_USER_PASSWORD in env.
...
const OUT  = path.resolve('contest/winner/after-screenshots-v2');
